...
export const metadata: Metadata = {
  title: "Términos y condiciones · ApartCBA",
  description:
    "Términos y condiciones de uso del servicio de gestión de alojamientos temporales y canales de mensajería de ApartCBA.",
};
    ...
    <article className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <Section title="1. Aceptación de los términos">
        <p>
          ...
          uso del servicio prestado por <strong>ApartCBA</strong> (en adelante,
          &quot;ApartCBA&quot;, &quot;nosotros&quot;), incluyendo la plataforma de gestión de
      ...
      <Section title="2. Descripción del servicio">
        <p>
          ApartCBA opera y administra alojamientos temporales (departamentos
        ...
        <p>
          ApartCBA no es una agencia de viajes registrada. La relación
          contractual de hospedaje se establece entre el huésped y el operador
          (ApartCBA o el propietario representado, según el caso), conforme la
      ...
      <Section title="3. Proceso de reserva">
        ...
        <p>
          La reserva queda confirmada cuando: (i) ApartCBA acuse recibo del
          ...
          ApartCBA emita la confirmación por escrito (email o WhatsApp). Antes
      ...
      <Section title="4. Pagos">
        <ul>
          ...
          <li>
            <strong>Facturación:</strong> ApartCBA emite el comprobante fiscal
      ...
      <Section title="5. Cancelaciones y reembolsos">
        ...
        <ul>
          ...
          <li>
            <strong>Cancelación por ApartCBA:</strong> si por causas
      ...
      <Section title="7. Limitación de responsabilidad">
        <p>
          ApartCBA se compromete a actuar con diligencia profesional en la
        ...
        <p>
          En todos los casos, la responsabilidad máxima de ApartCBA frente al
      ...
      <Section title="8. Uso de los canales de mensajería">
        <p>
          ApartCBA ofrece atención por Instagram Direct y WhatsApp Business.
      ...
      <Section title="9. Propiedad intelectual">
        <p>
          ...
          propiedad de ApartCBA o de los propietarios que representamos, y
      ...
      <Section title="10. Modificaciones a estos Términos">
        <p>
          ApartCBA se reserva el derecho de modificar estos Términos en
