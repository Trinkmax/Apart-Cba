...
export const metadata: Metadata = {
  title: "Eliminación de datos · ApartCBA",
  description:
    "Cómo solicitar la eliminación de tus datos personales recolectados por ApartCBA a través de Instagram, WhatsApp o el formulario de reservas.",
};
    ...
    <article className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <section className="mb-8 rounded-lg border border-border bg-muted/30 p-4 sm:p-6">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          Si querés que eliminemos los datos personales que ApartCBA tiene sobre
      ...
      <Section title="¿Qué datos elimino al pedir esto?">
        <p>
          Al confirmar tu solicitud, ApartCBA eliminará o anonimizará en forma
          permanente:
        </p>
        <ul>
          <li>
      ...
      <Section title="Eliminación automática desde Instagram / Facebook">
        <p>
          Si revocás los permisos de ApartCBA directamente desde tu configuración
        ...
        <p className="text-sm text-muted-foreground">
          Conforme la <em>Meta Platform Policy</em>, ApartCBA expone un
      ...
      <p className="mt-12 text-xs text-muted-foreground">
        ...
        <a href="/legal/privacidad">Política de privacidad</a> de ApartCBA.
      </p>
    </article>
  );
}
