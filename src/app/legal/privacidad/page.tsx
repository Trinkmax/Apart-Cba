...
export const metadata: Metadata = {
  title: "Política de privacidad · ApartCBA",
  description:
    "Cómo ApartCBA recolecta, usa, almacena y protege la información personal de huéspedes, propietarios y contactos.",
};
  ...
  return (
    <article className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <Section title="1. Identidad del responsable">
        <p>
          <strong>ApartCBA</strong> (en adelante, &quot;ApartCBA&quot;, &quot;nosotros&quot;) es una
      ...
      <Section title="2. Datos que recopilamos">
        ...
        <p>
          ...
          WhatsApp Business, ApartCBA recibe automáticamente:
        </p>
        <ul>
      ...
      <Section title="5. Con quién compartimos tus datos">
        <p>
          ApartCBA <strong>no vende ni alquila</strong> tus datos personales a
      ...
      <Section title="8. Seguridad">
        <p>
          ApartCBA aplica medidas técnicas y organizativas razonables para
      ...
      <Section title="9. Menores de edad">
        <p>
          ApartCBA no presta servicios a menores de 18 años de forma directa. No
