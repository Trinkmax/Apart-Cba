    ...
    <Card className="overflow-hidden">
      <div className="divide-y">
        {movements.map((m) => {
          ...
          return (
            <div key={m.id} className="grid grid-cols-12 items-center gap-3 p-3 hover:bg-accent/30 transition-colors">
              <div className="col-span-1 flex items-center">
                ...
                >
                  {isTransfer ? <ArrowRightLeft size={14} /> : isIn ? <ArrowDownToLine size={14} /> : <ArrowUpFromLine size={14} />}
                </div>
              </div>
