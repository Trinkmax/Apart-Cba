...
const ES_AR = {
  ...
  // ── Modo de estadía (tabs Temporales / Mensuales) ───────────────────────
  "mode.temporales": "Temporales",
  "mode.temporales.sub": "por noche",
  "mode.mensuales": "Mensuales",
  "mode.mensuales.sub": "por mes",
  "featured.per_month": "/mes",
  "card.badge_mensual": "Alquiler mensual",
...
const EN_US: Dict = {
  ...
  "mode.temporales": "Short stays",
  "mode.temporales.sub": "per night",
  "mode.mensuales": "Monthly",
  "mode.mensuales.sub": "per month",
  "featured.per_month": "/month",
  "card.badge_mensual": "Monthly rental",
...
const PT_BR: Dict = {
  ...
  "mode.temporales": "Temporadas",
  "mode.temporales.sub": "por noite",
  "mode.mensuales": "Mensais",
  "mode.mensuales.sub": "por mês",
  "featured.per_month": "/mês",
  "card.badge_mensual": "Aluguel mensal",
